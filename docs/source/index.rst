...
使用复旦大学非官方的 `物理实验报告模板 <https://github.com/stone-zeng/fduthesis>`_，
并阅读 :doc:`convention` 一节了解国标 GB/T 7713.2—2022 对学术写作中公式书写的规范要求。

.. tip::

   下面是一些常用工具的链接：
   1. `Overleaf 中国站，用于排版实验报告 <https://cn.overleaf.com/>`_
   2. `可视化符号转 LaTeX 代码 <https://editor.codecogs.com/>`_

本手册将涵盖以下内容：
1. 原实验讲义的高清重排，感谢 21 级同学对实验流程中的必要图片使用 ``tikz`` 重新绘制；
2. 对实验内容的扩展讨论与相关内容补充；
